...
import { updateCartItemQty, removeErrors, removeItemFromCart, removeMessage } from '../features/cart/cartSlice'
    ...
    <div className="cart-item">
      <div className="item-info">
        ...
        <div className="item-details">
          ...
          {item.size && (
            <p className="item-size" style={{ fontSize: '13px', color: '#555', margin: '3px 0' }}>
              <strong>Size: </strong><span style={{ textTransform: 'uppercase', fontWeight: '700', color: '#111' }}>{item.size}</span>
            </p>
          )}
